...
def load_from_storage(url):
    ...
    if latest_blob:
        ...
        print(f"Loaded previous content from Cloud Storage (last modified: {latest_updated})")
        return content
    else:
        print("No previous content found in Cloud Storage.")
        return ""
...
def save_to_storage(url, content):
    ...
    print(f"Saved new content to Cloud Storage (hash: {content_hash}, last modified: {blob.updated})")
